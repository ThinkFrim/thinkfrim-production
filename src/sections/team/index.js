...
const Team = () => {
  return (
    <section id='team'>
      <div className=''>
          <div className='text-center py-20 md:text-left md:flex md:items-center md:ml-10'>
              ...
              return (
                <div className='relative before:bg-black before:bg-opacity-60 before:absolute before:top-[0%] before:w-[100%] before:h-[100%]' key={team.id}>
                  <div className='text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                    <h1 className='White text-lg lg:text-2xl pb-2'>{team.title}</h1>
                    <h2 className='White text-sm lg:text-lg'>{team.position}</h2>
                  </div>
                  <div>
