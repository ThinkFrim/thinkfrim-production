    ...
    <section id="team">
      <div className="">
        <div className="text-center py-20 xl:py-[10rem]">
          <h1 className="text-xl pb-5 md:mx-3 xl:text-4xl xl:leading-[3.5rem]">
            Meet Multi-Talented people who are passionate{" "}
            <br className="hidden md:inline" /> about their craft
          </h1>
