                ...
                <div className='grid grid-cols-2 lg:grid-cols-4 md:grid-cols-2'>
                    {
                        DataService.map((items) => {
                            return (
                                <div className='relative before:bg-black before:bg-opacity-60 before:absolute before:top-[0%] before:w-[100%] before:h-[100%] lg:before:h-[120%]' >
                                    ...
                                    <img src={items.img} alt="" className='w-full lg:h-[120%] object-cover' />
                                </div>
                            )
                        })
                    }
