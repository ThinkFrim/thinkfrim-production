...
const Footer = () => {
    return (
        ...
        <footer className="chineseBlackBg dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex items-center">
                            <img src="/media/logo/ThinkFrimLogo.svg" className="h-8 mr-3" alt="FlowBite Logo" />
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://www.instagram.com/thinkfrim/" className="hover:underline hover:text-white">Instagram</a>
                                </li>
                                <li>
                                    <a href="https://discord.gg/fRJezHb5" className="hover:underline hover:text-white">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; {new Date().getFullYear()} <a href="/" className="hover:underline hover:text-[#F9BC60]">ThinkFrim™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://www.instagram.com/thinkfrim/" className="text-gray-500  hover:text-white">
                        ...
                        <a href="https://github.com/ThinkFrim" className="text-gray-500 hover:text-white">
