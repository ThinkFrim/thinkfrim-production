...
const Footer = () => {
    return (
        ...
        <footer className="chineseBlackBg dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; {new Date().getFullYear()} <a href="https://flowbite.com/" className="hover:underline">ThinkFrim™</a>. All Rights Reserved.
                    </span>
        ...
        // <footer className="chineseBlackBg border-t-[1px] border-white dark:bg-gray-900">
        //     <div className="mx-auto w-full max-w-screen-xl p-4 py-6">
        //         <div className="md:flex md:justify-between mt-auto">
        //             <div className="mb-6 md:mb-0">
        ...
        //         <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
        //         <div className="sm:flex sm:items-center sm:justify-between">
        //             <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; {new Date().getFullYear()}<a href="#" className="hover:underline">ThinkFrim™</a>. All Rights Reserved.
        //             </span>
        //             <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
